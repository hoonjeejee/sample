  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("localizations.demoDataTableTitle"),
      ),
      body: Scrollbar(
        child: ListView(
          ...
          children: [
            PaginatedDataTable(
              header: const Text("localizations.dataTableHeader"),
              ...
              columns: [
                DataColumn(
                  label: const Text("localizations.dataTableColumnDessert"),
                  onSort: (columnIndex, ascending) =>
                      _sort<String>((d) => d.name, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnCalories"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.calories, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text('localizations.dataTableColumnFat'),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.fat, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnCarbs"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.carbs, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnProtein"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.protein, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnSodium"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.sodium, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnCalcium"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
                      _sort<num>((d) => d.calcium, columnIndex, ascending),
                ),
                DataColumn(
                  label: const Text("localizations.dataTableColumnIron"),
                  numeric: true,
                  onSort: (columnIndex, ascending) =>
